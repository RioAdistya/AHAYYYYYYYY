...
*/
Route::get('/phpinfo', function () {phpinfo();})->name('php.info');
...
Route::group(['namespace' => 'App\Http\Controllers'], function () {
	...
	Route::middleware(['guest'])->controller('AuthController')->group(function () {
		Route::prefix('register')->name('register')->group(function () {
			...
			Route::post('/', 'register')->middleware(['throttle:user'])->name('.perform');
		});
		Route::prefix('login')->name('login')->group(function () {
			Route::get('/', 'showlogin');
			Route::post('/', 'login')->middleware(['throttle:user'])->name('.perform');
		});
